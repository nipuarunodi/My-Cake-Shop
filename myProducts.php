                ...
                <tr>
                    <td colspan="2">
                        ...
                        <div class="dashbord dashbord-green">
                            <div class="detail-section"> <a href="addCake.php">Add New Cake </a> </div>
                        </div>
                        </div>
                    </td>
                </tr>
                <tr style="height:2px;" bgcolor="#000000">
                    <td  colspan="2"> </td>   
                </tr>
                <tr>
                            ...
                            <tr>
                                <td width="534" colspan="2" bgcolor="#FFFFFF">
                                    <h1 class="loginHeader">Available Cake List</h1>
                                        ...
                                        $sql ="SELECT * FROM `cakes` WHERE `shopEmail`='".$_SESSION['email']."'";	
			                        ...
			                        <div class="listImage" style="width:49%; border:1px solid #000000; padding: 10px">
                                        <a href="<?php echo $row['imageName'];?>">
                                            ...
                                            <a class="cardButton" style="background-color: #119e40;" href="editCake.php?id=<?php echo $row['id']; ?>">EDIT</a>  
                                            <a class="cardButton" style="background-color: #e23408;" href="deleteCake.php?id=<?php echo $row['id']; ?>">DELETE</a>
                                            </div>
                                        </div>		
				                    </div>                                      
				                    <?php
